...
@PrepareForTest({ FXMLLoader.class, LoginController.class })
class LoginTest {
    ...
    @Test
    public void testNavigateToAdminDashboard() {
        Platform.runLater(() -> {
            // Mock the behavior of FXMLLoader
            Parent mockRoot = mock(Parent.class);
            try {
                PowerMockito.mockStatic(FXMLLoader.class);
                when(FXMLLoader.load(getClass().getResource("/application/AdminDash.fxml"))).thenReturn(mockRoot);
            } catch (IOException e) {
                e.printStackTrace();
            }
            ...
            // Call the navigateToAdminDashboard method
            loginController.navigateToAdminDashboard();
    ...
    @Test
    public void testNavigateToHomeScreen() {
        Platform.runLater(() -> {
            // Mock the behavior of FXMLLoader
            Parent mockRoot = mock(Parent.class);
            try {
                PowerMockito.mockStatic(FXMLLoader.class);
                when(FXMLLoader.load(getClass().getResource("/application/UserPage.fxml"))).thenReturn(mockRoot);
            } catch (IOException e) {
                e.printStackTrace();
            }
            ...
            // Call the navigateToHomeScreen method
    ...
    public void testShowInfoAlert() {
        Platform.runLater(() -> {
            ...
            loginController.showInfoAlert("Test Information Message");
    ...
    public void testShowErrorAlert() {
        Platform.runLater(() -> {
            ...
            loginController.showErrorAlert("Test Error Message");
